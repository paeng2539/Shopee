  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const args = [
        ...
        `zoompan=z='min(zoom+0.002,1.15)':d=75:s=720x1280:fps=15,` +
        `drawtext=text='${safeText}':fontcolor=white:fontsize=40:box=1:boxcolor=black@0.5:boxborderw=16:x=(w-text_w)/2:y=h-260,` +
        `drawtext=text='${priceText}':fontcolor=yellow:fontsize=46:box=1:boxcolor=black@0.5:boxborderw=16:x=(w-text_w)/2:y=h-180`,
        "-t", "5",
        "-preset", "ultrafast",
        "-pix_fmt", "yuv420p",
        outFile,
